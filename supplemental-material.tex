...
\NormalTok{  ) }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_y_continuous}\NormalTok{(}
    \DataTypeTok{name=}\StringTok{"Mutational stability"}\NormalTok{,}
...
## t1* 0.8247126 0.0002844828  0.04034365
\end{verbatim}
...
## Bootstrap Statistics :
##      original        bias    std. error
## t1* 0.5172414 -0.0005895402  0.03987024
\end{verbatim}
...
## Bootstrap Statistics :
##      original        bias    std. error
## t1* 0.4827586 -0.0008157471  0.03977862
\end{verbatim}
...
\includegraphics{supplemental-material_files/figure-latex/unnamed-chunk-67-2.pdf}
