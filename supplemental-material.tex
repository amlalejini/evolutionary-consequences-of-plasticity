...
\NormalTok{  ) }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_y_continuous}\NormalTok{(}
    \DataTypeTok{name=}\StringTok{"Frequency of coalescence events (generations)"}\NormalTok{,}
...
## t1* 0.8247126 0.0003531609  0.03951616
\end{verbatim}
...
## Bootstrap Statistics :
##      original        bias    std. error
## t1* 0.5172414 -0.0007896552   0.0394132
\end{verbatim}
...
## Bootstrap Statistics :
##      original       bias    std. error
## t1* 0.4827586 4.149425e-05  0.03974971
\end{verbatim}
...
\StringTok{    }\KeywordTok{theme}\NormalTok{(}
      ...
      \DataTypeTok{axis.title.x=}\KeywordTok{element_blank}\NormalTok{()}
\NormalTok{    ) }\OperatorTok{+}
\StringTok{    }\KeywordTok{ggtitle}\NormalTok{(}\StringTok{"Frequency of coalescence events"}\NormalTok{),}
