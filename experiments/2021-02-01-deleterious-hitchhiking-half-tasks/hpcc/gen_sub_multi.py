...
combos.register_var('POISON_VALUE')

combos.add_val(
    'EVENT_FILE_PREFIX',
    [
        'events_env-enva_rate-u0',
        'events_env-envb_rate-u0',
...
combos.add_exception(
    {'EVENT_FILE_PREFIX': 'events_env-enva_rate-u0', 'DISABLE_SENSORS': '0'}
)
combos.add_exception(
    {'EVENT_FILE_PREFIX': 'events_env-envb_rate-u0', 'DISABLE_SENSORS': '0'}
)
...
def main():
    ...
    for condition_dict in combo_list:
        ...
        run_param_info["ENVIRONMENT_FILE"] = 'environment.cfg'
        ...
        if condition_dict['DISABLE_SENSORS'] == '0':
        ...
        run_param_info["SYSTEMATICS_RES"] = '10000'
        run_param_info["RANDOM_SEED"] = '${SEED}'
        run_param_info["POISON_PENALTY"] = condition_dict["POISON_VALUE"]
        run_param_info["FORCE_MRCA_COMP"] = "1"
        # Genome length controls
        run_param_info["DIVIDE_INS_PROB"] = "0.0"
        run_param_info["DIVIDE_DEL_PROB"] = "0.0"
        ...
        # Add commands to run avida analyze mode
        analysis_fname = "analysis-hitchhiking.cfg"
        analysis_commands = ''
        analysis_commands += f'RUN_PARAMS="{run_params}"\n'
