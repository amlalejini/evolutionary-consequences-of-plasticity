...
## Final novel task count (dominant genotype)
...
## Novel task count (final population)
...
## Novel task discovery frequency (lineage)
...
## Frequency of novel task loss (lineage)
