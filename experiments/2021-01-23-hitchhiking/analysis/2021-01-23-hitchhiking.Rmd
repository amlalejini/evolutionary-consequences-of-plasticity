...
working_directory <- "experiments/2021-01-23-hitchhiking/analysis/" # << For bookdown
# working_directory <- "./"
```
...
pairwise.wilcox.test(
  x=dom_data$dominant_times_poison_executed,
  g=dom_data$condition,
