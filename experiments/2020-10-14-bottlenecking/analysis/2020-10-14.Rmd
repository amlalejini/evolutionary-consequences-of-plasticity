---
title: "2020-10-14 Experiment Analysis"
output:
  html_document:
    keep_md: no
    toc: true
...
agg_data$bottleneck_size <- as.factor(agg_data$kill_prob)
...
ggplot(filter(agg_data, dom_optimal_plastic=="True"), aes(x=sensors, fill=sensors)) +
  ...
  ylim(0, 105) +
  facet_grid(bottleneck_size~environment) +
