...
def main():
    ...
    for condition_dict in combo_list:
        ...
        if condition_dict['SENSORS'] == '0' and condition_dict["EVENT_FILE_PREFIX"] != "events-ALL-u0":
        ...
        # environment file
        env_file_name = None
        if condition_dict["EXTRA_TASK_REWARD"] == "NONE":
            env_file_name = "environment-L77_phase-one.cfg"
        else:
