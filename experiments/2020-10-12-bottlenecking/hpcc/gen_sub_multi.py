...
combos.add_exception({"EVENT_FILE_PREFIX": 'events-chg-u100', 'DISABLE_SENSORS': '1'})
...
def main():
    ...
    for condition_dict in combo_list:
        ...
        event_file_name = f"{condition_dict['EVENT_FILE_PREFIX']}_phase-two_kp-{condition_dict['KILL_PROB']}.cfg"
