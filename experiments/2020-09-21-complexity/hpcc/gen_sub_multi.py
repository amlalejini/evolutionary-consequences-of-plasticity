...
combos.register_var('ENVIRONMENT')
combos.add_val(
    'EVENT_FILE_PREFIX',
    [
        'events-ALL-u0',
...
def main():
    ...
    for condition_dict in combo_list:
        ...
        run_params += f' -set ENVIRONMENT_FILE environment-{condition_dict["ENVIRONMENT"]}_phase-one.cfg'
        ...
        analysis_commands += f' -set ANALYZE_FILE avida-analysis-{condition_dict["ENVIRONMENT"]}.cfg'
        analysis_commands += ' -a\n'
        ...
        run_params += f' -set ENVIRONMENT_FILE environment-{condition_dict["ENVIRONMENT"]}_phase-two.cfg'
        run_params +=  ' -set COPY_MUT_PROB 0.0025'
        run_params += f' -set DISABLE_REACTION_SENSORS {condition_dict["SENSORS"]}'
        run_params +=  ' -set REACTION_SENSORS_NEUTRAL 0.0'
        run_params +=  ' -set PHYLOGENY_SNAPSHOT_RES 200000'
